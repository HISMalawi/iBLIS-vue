<template>
  <ion-page>
    <tool-bar pageTitle="iBLIS | Rejected Orders" defaltBackButtonLink="/home" />

    <ion-content :fullscreen="true">
      <collapse-tool-bar pageTitle="iBLIS | Rejected Orders" />
...
import GetSiteRejectedOrders from "@/composables/getSiteRejectedOrders";
